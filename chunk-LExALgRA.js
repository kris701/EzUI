...
interface Example {
	...
	{ id:"55g", value: "1115892", desc: "works :)" },
	{ id:"dfg", value: "yyes", desc: "works" },
]`,3,`enableTypescript`],[2,`height`,`300px`],[3,`values`],[`tuiTh`,``],[`tuiTd`,``],[3,`onRowClick`,`values`,`clickable`],[3,`onRowClick`,`values`,`clickable`,`showContextMenu`,`contextMenuItems`],[3,`values`,`expandable`],[`colSpan`,`4`],[2,`margin`,`10px`],[3,`values`,`pageSize`],[`appearance`,`warning`,`tuiMessage`,``,2,`width`,`100%`],[3,`values`,`showClearFilters`],[`column`,`id`],[`column`,`value`],[`column`,`desc`],[`column`,`type`,3,`options`],[`column`,`timestamp`],[`column`,`active`],[`size`,`xs`,`tuiChip`,``],[`column`,`type`,3,`options`,`appearanceMap`],[`size`,`xs`,`tuiChip`,``,3,`appearance`],[`column`,`type`],[`storageKey`,`ezui-table`,3,`values`,`showClearFilters`,`allowPresets`],[`column`,`types`,`optionLabel`,`value`,`optionValue`,`id`,3,`options`,`appearanceMap`],[`size`,`xs`,`tuiChip`,``,2,`margin-right`,`5px`,3,`appearance`]],template:function(e,w){e&1&&(g(0,`app-samplecontainer`,4),Z(1,ge,2,0,`ng-template`,null,0,Vt),v(),g(3,`app-samplecontainer`,5),Z(4,_e,5,1,`ng-template`,null,0,Vt),v(),g(6,`app-samplecontainer`,6),Z(7,he,5,2,`ng-template`,null,0,Vt),v(),g(9,`app-samplecontainer`,7),Z(10,Se,5,4,`ng-template`,null,0,Vt),v(),g(12,`app-samplecontainer`,8),Z(13,Ce,7,2,`ng-template`,null,0,Vt),v(),g(15,`app-samplecontainer`,9),Z(16,Ve,5,2,`ng-template`,null,0,Vt),v(),g(18,`app-samplecontainer`,10),Z(19,Oe,7,2,`ng-template`,null,0,Vt),v(),g(21,`app-samplecontainer`,11),Z(22,Be,7,2,`ng-template`,null,0,Vt),v(),g(24,`app-samplecontainer`,12),Z(25,We,7,2,`ng-template`,null,0,Vt),v(),g(27,`app-samplecontainer`,13),Z(28,je,7,2,`ng-template`,null,0,Vt),v(),g(30,`app-samplecontainer`,14),Z(31,Ke,7,3,`ng-template`,null,0,Vt),v(),g(33,`app-samplecontainer`,15),Z(34,Xe,7,2,`ng-template`,null,0,Vt),v(),g(36,`app-samplecontainer`,16),Z(37,tt,5,1,`ng-template`,null,0,Vt),v()),e&2&&(m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0),m(3),C(`enableTypescript`,!0))},dependencies:[Kt,St,_c,G,AO,WS,LVe,h,OVe,FVe,PVe,qr,AVe,RVe,IU],encapsulation:2})};function it(t,l){if(t&1){let e=L$1();g(0,`ezui-orderlist`,8),Ve$1(`valuesChange`,function(c){E(e);let y=f();return ze$1(y.values,c)||(y.values=c),M$1(c)}),v(),A(1),zt(2,`json`)}if(t&2){let e=f();Le$1(`values`,e.values),m(),X(` `,rr(2,2,e.values),` `)}}function nt(t,l){t&1&&Y(0,`ezui-orderlist`)}function at(t,l){if(t&1){let e=L$1();g(0,`ezui-orderlist`,9),Ve$1(`valuesChange`,function(c){E(e);let y=f();return ze$1(y.values,c)||(y.values=c),M$1(c)}),v()}if(t&2)Le$1(`values`,f().values),C(`disabled`,!0)}function lt(t,l){if(t&1){let e=L$1();g(0,`ezui-orderlist`,10),Ve$1(`valuesChange`,function(c){E(e);let y=f();return ze$1(y.values,c)||(y.values=c),M$1(c)}),v(),A(1),zt(2,`json`)}if(t&2){let e=f();Le$1(`values`,e.values),C(`showButtons`,!0),m(),X(` `,rr(2,3,e.values),` `)}}function rt(t,l){if(t&1&&(g(0,`div`,16)(1,`h3`),A(2),v(),g(3,`span`),A(4),v()()),t&2){let e=l.$implicit;m(2),ct(e.label),m(2),ct(e.label)}}function mt(t,l){if(t&1){let e=L$1();g(0,`div`,14)(1,`h1`),A(2,`Order List`),v(),g(3,`ezui-orderlist`,15),Ve$1(`valuesChange`,function(c){E(e);let y=f(2);return ze$1(y.values2,c)||(y.values2=c),M$1(c)}),Z(4,rt,5,2,`ng-template`,null,2,Vt),v()()}if(t&2){let e=f(2);m(3),Le$1(`values`,e.values2)}}function pt(t,l){if(t&1){let e=L$1();g(0,`span`,11),A(1,` The "EzUILayoutService" is required for the dialog to correctly format on mobile! `),v(),g(2,`button`,12),w(`click`,function(){E(e);return M$1(f().showDialog.set(!0))}),A(3,` Open `),v(),g(4,`ezui-dialog`,13),Z(5,mt,6,1,`ng-template`,null,1,Vt),v()}if(t&2){let e=f();m(4),C(`showDialog`,e.showDialog)}}var L=class t{values=[{label:`item1`,icon:`list`},{label:`item2`,icon:`list`},{label:`item3`,icon:`list`},{label:`item4`,icon:`list`}];showDialog=O$1(!1);values2=[{label:`item1`,icon:`list`},{label:`item2`,icon:`list`},{label:`item3`,icon:`list`},{label:`item4`,icon:`list`},{label:`item5`,icon:`list`},{label:`item6`,icon:`list`},{label:`item7`,icon:`list`},{label:`item8`,icon:`list`},{label:`item9`,icon:`list`},{label:`item10`,icon:`list`},{label:`item11`,icon:`list`},{label:`item12`,icon:`list`},{label:`item13`,icon:`list`},{label:`item14`,icon:`list`},{label:`item15`,icon:`list`}];static ɵfac=function(e){return new(e||t)};static ɵcmp=k({type:t,selectors:[[`app-orderlist`]],hostAttrs:[1,`base-view`],decls:15,vars:1,consts:[[`preview`,``],[`content`,``],[`itemTemplate`,``],[`label`,`Simple`,`html`,``],[`label`,`Empty`,`html`,``],[`label`,`Disabled`,`html`,``],[`label`,`Buttons`,`html`,``],[`label`,`In DIalog`,`html`,`<button tuiButton (click)="showDialog.set(true)">
	Open
</button>
...
</ezui-dialog>`,`ts`,`showDialog = signal<boolean>(false);`,3,`enableTypescript`],[`optionLabel`,`label`,3,`valuesChange`,`values`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`disabled`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`showButtons`],[`appearance`,`warning`,`tuiMessage`,``,2,`width`,`100%`],[`tuiButton`,``,3,`click`],[3,`showDialog`],[2,`height`,`80vh`,`overflow`,`auto`],[3,`valuesChange`,`values`],[2,`display`,`flex`,`flex-direction`,`column`]],template:function(e,w){e&1&&(g(0,`app-samplecontainer`,3),Z(1,it,3,4,`ng-template`,null,0,Vt),v(),g(3,`app-samplecontainer`,4),Z(4,nt,1,0,`ng-template`,null,0,Vt),v(),g(6,`app-samplecontainer`,5),Z(7,at,1,2,`ng-template`,null,0,Vt),v(),g(9,`app-samplecontainer`,6),Z(10,lt,3,5,`ng-template`,null,0,Vt),v(),g(12,`app-samplecontainer`,7),Z(13,pt,7,1,`ng-template`,null,0,Vt),v()),e&2&&(m(12),C(`enableTypescript`,!0))},dependencies:[Kt,St,G,EVe,yVe,Xe$1,EU],encapsulation:2})};var Xt=[{path:`markdowneditor`,component:F},{path:`tables`,component:O},{path:`iconselector`,component:M},{path:`showmoretext`,component:P},{path:`orderlist`,component:L}];export{Xt as default};