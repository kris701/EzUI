...
]`,3,`enableTypescript`],[3,`items`]],template:function(e,y$1){e&1&&(y(0,`app-samplecontainer`,1),re(1,d,1,1,`ng-template`,null,0,Dn),_(),y(3,`app-samplecontainer`,2),re(4,f,1,1,`ng-template`,null,0,Dn),_()),e&2&&(x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0))},dependencies:[An,pn,Q9,Y],encapsulation:2})}}];export{z as default};