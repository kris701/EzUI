...
interface Example {
	...
	{ id:"55g", value: "1115892", desc: "works :)" },
	{ id:"dfg", value: "yyes", desc: "works" },
]`,3,`enableTypescript`],[2,`height`,`300px`],[3,`values`],[`tuiTh`,``],[`tuiTd`,``],[3,`onRowClick`,`values`,`clickable`],[3,`values`,`expandable`],[`colSpan`,`4`],[2,`margin`,`10px`],[3,`values`,`pageSize`],[`appearance`,`warning`,`tuiMessage`,``,2,`width`,`100%`],[3,`values`,`showClearFilters`],[`column`,`id`],[`column`,`value`],[`column`,`desc`],[`column`,`type`,3,`options`],[`column`,`timestamp`],[`column`,`active`],[`size`,`xs`,`tuiChip`,``],[`column`,`type`],[`storageKey`,`ezui-table`,3,`values`,`showClearFilters`,`allowPresets`],[`column`,`types`,`optionLabel`,`value`,`optionValue`,`id`,3,`options`],[`size`,`xs`,`tuiChip`,``,2,`margin-right`,`5px`]],template:function(t,g){t&1&&(v(0,`app-samplecontainer`,4),X(1,we,2,0,`ng-template`,null,0,Vt),_(),v(3,`app-samplecontainer`,5),X(4,ve,5,1,`ng-template`,null,0,Vt),_(),v(6,`app-samplecontainer`,6),X(7,Te,5,2,`ng-template`,null,0,Vt),_(),v(9,`app-samplecontainer`,7),X(10,Ee,7,2,`ng-template`,null,0,Vt),_(),v(12,`app-samplecontainer`,8),X(13,De,5,2,`ng-template`,null,0,Vt),_(),v(15,`app-samplecontainer`,9),X(16,Me,7,2,`ng-template`,null,0,Vt),_(),v(18,`app-samplecontainer`,10),X(19,Ve,7,2,`ng-template`,null,0,Vt),_(),v(21,`app-samplecontainer`,11),X(22,Le,7,2,`ng-template`,null,0,Vt),_(),v(24,`app-samplecontainer`,12),X(25,Ue,7,3,`ng-template`,null,0,Vt),_(),v(27,`app-samplecontainer`,13),X(28,Ne,7,2,`ng-template`,null,0,Vt),_(),v(30,`app-samplecontainer`,14),X(31,$e,5,1,`ng-template`,null,0,Vt),_()),t&2&&(m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0))},dependencies:[Yt,Ct,hc,G,bO,FS,n5e,h,XVe,t5e,e5e,bo,KVe,JVe,hH],encapsulation:2})};function Ke(e,l){if(e&1){let t=z();v(0,`ezui-orderlist`,5),Ve$1(`valuesChange`,function(c){M(t);let y=f();return ze$1(y.values,c)||(y.values=c),N(c)}),_(),A(1),zt(2,`json`)}if(e&2){let t=f();Le$1(`values`,t.values),m(),Y(` `,rr(2,2,t.values),` `)}}function Je(e,l){e&1&&q(0,`ezui-orderlist`)}function Ge(e,l){if(e&1){let t=z();v(0,`ezui-orderlist`,6),Ve$1(`valuesChange`,function(c){M(t);let y=f();return ze$1(y.values,c)||(y.values=c),N(c)}),_()}if(e&2)Le$1(`values`,f().values),w(`disabled`,!0)}function Qe(e,l){if(e&1){let t=z();v(0,`ezui-orderlist`,7),Ve$1(`valuesChange`,function(c){M(t);let y=f();return ze$1(y.values,c)||(y.values=c),N(c)}),_(),A(1),zt(2,`json`)}if(e&2){let t=f();Le$1(`values`,t.values),w(`showButtons`,!0),m(),Y(` `,rr(2,3,t.values),` `)}}var O=class e{values=[{label:`item1`,icon:`list`},{label:`item2`,icon:`list`},{label:`item3`,icon:`list`},{label:`item4`,icon:`list`}];static ɵfac=function(t){return new(t||e)};static ɵcmp=k({type:e,selectors:[[`app-orderlist`]],hostAttrs:[1,`base-view`],decls:12,vars:0,consts:[[`preview`,``],[`label`,`Simple`,`html`,``],[`label`,`Empty`,`html`,``],[`label`,`Disabled`,`html`,``],[`label`,`Buttons`,`html`,``],[`optionLabel`,`label`,3,`valuesChange`,`values`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`disabled`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`showButtons`]],template:function(t,g){t&1&&(v(0,`app-samplecontainer`,1),X(1,Ke,3,4,`ng-template`,null,0,Vt),_(),v(3,`app-samplecontainer`,2),X(4,Je,1,0,`ng-template`,null,0,Vt),_(),v(6,`app-samplecontainer`,3),X(7,Ge,1,2,`ng-template`,null,0,Vt),_(),v(9,`app-samplecontainer`,4),X(10,Qe,3,5,`ng-template`,null,0,Vt),_())},dependencies:[Yt,Ct,G,qVe,mH],encapsulation:2})};var Lt=[{path:`markdowneditor`,component:F},{path:`tables`,component:P},{path:`iconselector`,component:C},{path:`showmoretext`,component:V},{path:`orderlist`,component:O}];export{Lt as default};