...
]`,3,`enableTypescript`],[3,`items`]],template:function(t,u){t&1&&(y(0,`app-samplecontainer`,1),te(1,A,1,1,`ng-template`,null,0,yn),_(),y(3,`app-samplecontainer`,2),te(4,R,1,1,`ng-template`,null,0,yn),_()),t&2&&(x(`enableTypescript`,!0),m(3),x(`enableTypescript`,!0))},dependencies:[rn,qt,lZ,G],encapsulation:2})}},{path:`dialog`,component:w}];export{tt as default};