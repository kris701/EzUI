...
]`,3,`enableTypescript`],[3,`items`]],template:function(e,y$1){e&1&&(y(0,`app-samplecontainer`,1),ne(1,d,1,1,`ng-template`,null,0,xn),_(),y(3,`app-samplecontainer`,2),ne(4,f,1,1,`ng-template`,null,0,xn),_()),e&2&&(x(`enableTypescript`,!0),m(3),x(`enableTypescript`,!0))},dependencies:[hn,Gt,lY,Y],encapsulation:2})}}];export{z as default};