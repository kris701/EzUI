import{E as O,Et as zVe,H as Y,K as _,L as Vt,M as T,R as WVe,St as w,T as N$1,Tt as z,W as Yt,Z as bo,b as Ke,bt as uJ,ct as k,i as A$1,nt as f,pt as q$1,s as Ct,ut as m,w as M,xt as v,z as X}from"./main-YUSWSZPK.js";import{t as h}from"./chunk-Ds6r5D6F.js";import{t as G}from"./chunk-CezNBUvn.js";function R(t,n){t&1&&(v(0,`span`),A$1(1,`This is the content of the dialog`),_())}function V(t,n){if(t&1){let e=z();v(0,`span`,4),A$1(1,` The "EzUILayoutService" is required for the dialog to correctly format on mobile! `),_(),v(2,`button`,5),T(`click`,function(){M(e);return N$1(f().showDialog.set(!0))}),A$1(3,` Open `),_(),v(4,`ezui-dialog`,6),X(5,R,2,0,`ng-template`,null,1,Vt),_()}if(t&2){let e=f();m(4),w(`showDialog`,e.showDialog)}}function A(t,n){t&1&&(v(0,`span`),A$1(1,`This is the content of the dialog`),_())}function N(t,n){if(t&1){let e=z();v(0,`span`,4),A$1(1,` The "EzUILayoutService" is required for the dialog to correctly format on mobile! `),_(),v(2,`button`,5),T(`click`,function(){M(e);return N$1(f().showDialog2.set(!0))}),A$1(3,` Open `),_(),v(4,`ezui-dialog`,7),T(`onSaveItem`,function(){M(e);return N$1(f().showAlert(`saved!`))})(`onDeleteItem`,function(){M(e);return N$1(f().showAlert(`deleted!`))}),X(5,A,2,0,`ng-template`,null,1,Vt),_()}if(t&2){let e=f();m(4),w(`showDialog`,e.showDialog2)(`showDelete`,!0)(`showSave`,!0)}}var x=class t{showDialog=O(!1);showDialog2=O(!1);showAlert(n){alert(n)}static ɵfac=function(e){return new(e||t)};static ɵcmp=k({type:t,selectors:[[`app-dialog`]],hostAttrs:[1,`base-view`],decls:6,vars:2,consts:[[`preview`,``],[`content`,``],[`label`,`Simple`,`html`,`<button tuiButton (click)="showDialog.set(true)">
	Open
</button>
