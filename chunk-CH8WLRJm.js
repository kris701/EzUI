...
interface Example {
	...
	{ id:"55g", value: "1115892", desc: "works :)" },
	{ id:"dfg", value: "yyes", desc: "works" },
]`,3,`enableTypescript`],[2,`height`,`300px`],[3,`values`],[`tuiTh`,``],[`tuiTd`,``],[3,`onRowClick`,`values`,`clickable`],[3,`onRowClick`,`values`,`clickable`,`showContextMenu`,`contextMenuItems`],[3,`values`,`expandable`],[`colSpan`,`4`],[2,`margin`,`10px`],[3,`values`,`pageSize`],[`appearance`,`warning`,`tuiMessage`,``,2,`width`,`100%`],[3,`values`,`showClearFilters`],[`column`,`id`],[`column`,`value`],[`column`,`desc`],[`column`,`type`,3,`options`],[`column`,`timestamp`],[`column`,`active`],[`size`,`xs`,`tuiChip`,``],[`column`,`type`,3,`options`,`appearanceMap`],[`size`,`xs`,`tuiChip`,``,3,`appearance`],[`column`,`type`],[`storageKey`,`ezui-table`,3,`values`,`showClearFilters`,`allowPresets`],[`column`,`types`,`optionLabel`,`value`,`optionValue`,`id`,3,`options`,`appearanceMap`],[`size`,`xs`,`tuiChip`,``,2,`margin-right`,`5px`,3,`appearance`]],template:function(e,w){e&1&&(g(0,`app-samplecontainer`,4),Z(1,we,2,0,`ng-template`,null,0,Lt),v(),g(3,`app-samplecontainer`,5),Z(4,ve,5,1,`ng-template`,null,0,Lt),v(),g(6,`app-samplecontainer`,6),Z(7,_e,5,2,`ng-template`,null,0,Lt),v(),g(9,`app-samplecontainer`,7),Z(10,Ee,5,4,`ng-template`,null,0,Lt),v(),g(12,`app-samplecontainer`,8),Z(13,De,7,2,`ng-template`,null,0,Lt),v(),g(15,`app-samplecontainer`,9),Z(16,Me,5,2,`ng-template`,null,0,Lt),v(),g(18,`app-samplecontainer`,10),Z(19,Ve,7,2,`ng-template`,null,0,Lt),v(),g(21,`app-samplecontainer`,11),Z(22,He,7,2,`ng-template`,null,0,Lt),v(),g(24,`app-samplecontainer`,12),Z(25,Ue,7,2,`ng-template`,null,0,Lt),v(),g(27,`app-samplecontainer`,13),Z(28,qe,7,2,`ng-template`,null,0,Lt),v(),g(30,`app-samplecontainer`,14),Z(31,$e,7,3,`ng-template`,null,0,Lt),v(),g(33,`app-samplecontainer`,15),Z(34,Ge,7,2,`ng-template`,null,0,Lt),v(),g(36,`app-samplecontainer`,16),Z(37,Ze,5,1,`ng-template`,null,0,Lt),v()),e&2&&(m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0),m(3),C$1(`enableTypescript`,!0))},dependencies:[Kt,wt,hc,G,SO,FS,S5e,h,y5e,w5e,C5e,qr,_5e,b5e,vH],encapsulation:2})};function et(t,l){if(t&1){let e=L();g(0,`ezui-orderlist`,5),Ve$1(`valuesChange`,function(c){E(e);let y=f();return ze$1(y.values,c)||(y.values=c),M(c)}),v(),A(1),Ht(2,`json`)}if(t&2){let e=f();Le$1(`values`,e.values),m(),X(` `,rr(2,2,e.values),` `)}}function tt(t,l){t&1&&Y(0,`ezui-orderlist`)}function it(t,l){if(t&1){let e=L();g(0,`ezui-orderlist`,6),Ve$1(`valuesChange`,function(c){E(e);let y=f();return ze$1(y.values,c)||(y.values=c),M(c)}),v()}if(t&2)Le$1(`values`,f().values),C$1(`disabled`,!0)}function nt(t,l){if(t&1){let e=L();g(0,`ezui-orderlist`,7),Ve$1(`valuesChange`,function(c){E(e);let y=f();return ze$1(y.values,c)||(y.values=c),M(c)}),v(),A(1),Ht(2,`json`)}if(t&2){let e=f();Le$1(`values`,e.values),C$1(`showButtons`,!0),m(),X(` `,rr(2,3,e.values),` `)}}var O=class t{values=[{label:`item1`,icon:`list`},{label:`item2`,icon:`list`},{label:`item3`,icon:`list`},{label:`item4`,icon:`list`}];static ɵfac=function(e){return new(e||t)};static ɵcmp=k({type:t,selectors:[[`app-orderlist`]],hostAttrs:[1,`base-view`],decls:12,vars:0,consts:[[`preview`,``],[`label`,`Simple`,`html`,``],[`label`,`Empty`,`html`,``],[`label`,`Disabled`,`html`,``],[`label`,`Buttons`,`html`,``],[`optionLabel`,`label`,3,`valuesChange`,`values`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`disabled`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`showButtons`]],template:function(e,w){e&1&&(g(0,`app-samplecontainer`,1),Z(1,et,3,4,`ng-template`,null,0,Lt),v(),g(3,`app-samplecontainer`,2),Z(4,tt,1,0,`ng-template`,null,0,Lt),v(),g(6,`app-samplecontainer`,3),Z(7,it,1,2,`ng-template`,null,0,Lt),v(),g(9,`app-samplecontainer`,4),Z(10,nt,3,5,`ng-template`,null,0,Lt),v())},dependencies:[Kt,wt,G,h5e,_H],encapsulation:2})};var Nt=[{path:`markdowneditor`,component:F},{path:`tables`,component:P},{path:`iconselector`,component:C},{path:`showmoretext`,component:V},{path:`orderlist`,component:O}];export{Nt as default};