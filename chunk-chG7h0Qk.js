import{C as MAe,D as Ou,E as O,G as ee,H as am,I as TC,J as jt,K as g,L as W5,M as S,N as SAe,O as P,P as T,R as Wn,T as NAe,U as an,V as _t,Y as kAe,b as Lg,c as Dn,d as H,dt as x,et as pt,f as I,ht as yt,j as R$1,l as E,m as J,mt as y,n as AAe,nt as re$1,o as Cl,ot as v,pt as xn,r as Bk,s as DAe,st as vt,t as A,tt as q,u as EAe,x as Li,z as _}from"./main-SGEIHAKU.js";import{t as Y}from"./chunk-BiYViEGr.js";var te=(()=>{class e{static{this.ɵfac=function(u){return new(u||e)}}static{this.ɵcmp=I({type:e,selectors:[[`ng-component`]],exportAs:[`tui-message-5.18.0`],decls:0,vars:0,template:function(u,y){},styles:[`[tuiMessage]:where(*[data-tui-version="5.18.0"]){display:inline-flex;padding:.5rem .625rem;min-block-size:2.25rem;block-size:auto;box-sizing:border-box;inline-size:fit-content;isolation:isolate;white-space:nowrap;text-align:start;font:var(--%NS%tui-typography-ui-m);border-radius:var(--%NS%tui-radius-l)}[tuiMessage]:where(*[data-tui-version="5.18.0"])>[tuiLink]{color:inherit!important;text-decoration:underline solid!important}
...
longFilterData : any = [
	...
	{ id:"55g", type: "Type 2", timestamp: new Date() },
	{ id:"dfg", type: "Type 3", timestamp: new Date() },
]`,3,`enableTypescript`],[2,`height`,`300px`],[3,`values`],[`tuiTh`,``],[`tuiTd`,``],[3,`onRowClick`,`values`,`clickable`],[3,`values`,`pageSize`],[`appearance`,`warning`,`tuiMessage`,``,2,`width`,`100%`],[3,`values`,`showClearFilters`],[`column`,`id`],[`column`,`value`],[`column`,`desc`],[`column`,`type`,3,`options`],[`column`,`timestamp`],[`column`,`active`],[`size`,`xs`,`tuiChip`,``],[`column`,`type`],[`storageKey`,`ezui-table`,3,`values`,`showClearFilters`,`allowPresets`]],template:function(t,u){t&1&&(y(0,`app-samplecontainer`,3),re$1(1,re,2,0,`ng-template`,null,0,Dn),_(),y(3,`app-samplecontainer`,4),re$1(4,oe,5,1,`ng-template`,null,0,Dn),_(),y(6,`app-samplecontainer`,5),re$1(7,ye,5,2,`ng-template`,null,0,Dn),_(),y(9,`app-samplecontainer`,6),re$1(10,be,5,2,`ng-template`,null,0,Dn),_(),y(12,`app-samplecontainer`,7),re$1(13,ve,7,2,`ng-template`,null,0,Dn),_(),y(15,`app-samplecontainer`,8),re$1(16,he,7,2,`ng-template`,null,0,Dn),_(),y(18,`app-samplecontainer`,9),re$1(19,Ee,7,2,`ng-template`,null,0,Dn),_(),y(21,`app-samplecontainer`,10),re$1(22,Ie,7,3,`ng-template`,null,0,Dn),_()),t&2&&(v(3),x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0),v(3),x(`enableTypescript`,!0))},dependencies:[xn,an,Ou,Y,Bk,TC,AAe,Z,MAe,kAe,NAe,Cl,EAe,W5],encapsulation:2})};var rt=[{path:`markdowneditor`,component:M},{path:`tables`,component:R},{path:`iconselector`,component:C}];export{rt as default};