import{D as O,E as NAe,F as T,G as ee,H as am,J as jt,K as g,L as TC,M as R$1,N as S,O as Ou,P as SAe,R as Wn,S as Li,U as an,V as _t,Y as kAe,c as Dn,d as G5,dt as x,et as pt,f as H,h as J,ht as yt,k as P,l as E,mt as y,n as AAe,nt as re$1,o as Cl,ot as v,p as I,pt as xn,r as Bk,s as DAe,st as vt,t as A,tt as q,u as EAe,w as MAe,x as Lg,z as _}from"./main-5MAZTJAH.js";import{t as Y}from"./chunk-BofSbTkK.js";var te=(()=>{class e{static{this.ɵfac=function(u){return new(u||e)}}static{this.ɵcmp=I({type:e,selectors:[[`ng-component`]],exportAs:[`tui-message-5.18.0`],decls:0,vars:0,template:function(u,y){},styles:[`[tuiMessage]:where(*[data-tui-version="5.18.0"]){display:inline-flex;padding:.5rem .625rem;min-block-size:2.25rem;block-size:auto;box-sizing:border-box;inline-size:fit-content;isolation:isolate;white-space:nowrap;text-align:start;font:var(--%NS%tui-typography-ui-m);border-radius:var(--%NS%tui-radius-l)}[tuiMessage]:where(*[data-tui-version="5.18.0"])>[tuiLink]{color:inherit!important;text-decoration:underline solid!important}
