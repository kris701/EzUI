import{A as Sl,C as P,D as R$1,E as Qt,F as Vi,G as ft,I as We,J as ht,K as gn,L as Y5,M as UAe,N as Uk,O as RAe,Q as k,T as Pu,U as ee,Z as jAe,_t as xn,a as E,at as pt,bt as zg,c as Gn,et as lm,f as I,ft as un,gt as xC,ht as x,i as Bt,j as T,k as S,l as H,nt as mt,ot as q,p as J,pt as v,r as BAe,rt as ne,s as Ge,t as $Ae,tt as m,u as HAe,vt as y,w as PAe,x as O,z as _}from"./main-ZKZIAO76.js";import{t as Y}from"./chunk-BQkQjr3u.js";var ae=(()=>{class e{static{this.ɵfac=function(u){return new(u||e)}}static{this.ɵcmp=I({type:e,selectors:[[`ng-component`]],exportAs:[`tui-message-5.18.0`],decls:0,vars:0,template:function(u,y){},styles:[`[tuiMessage]:where(*[data-tui-version="5.18.0"]){display:inline-flex;padding:.5rem .625rem;min-block-size:2.25rem;block-size:auto;box-sizing:border-box;inline-size:fit-content;isolation:isolate;white-space:nowrap;text-align:start;font:var(--%NS%tui-typography-ui-m);border-radius:var(--%NS%tui-radius-l)}[tuiMessage]:where(*[data-tui-version="5.18.0"])>[tuiLink]{color:inherit!important;text-decoration:underline solid!important}
