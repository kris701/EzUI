...
interface Example {
	...
	{ id:"55g", value: "1115892", desc: "works :)" },
	{ id:"dfg", value: "yyes", desc: "works" },
]`,3,`enableTypescript`],[2,`height`,`300px`],[3,`values`],[`tuiTh`,``],[`tuiTd`,``],[3,`onRowClick`,`values`,`clickable`],[3,`values`,`expandable`],[`colSpan`,`4`],[2,`margin`,`10px`],[3,`values`,`pageSize`],[`appearance`,`warning`,`tuiMessage`,``,2,`width`,`100%`],[3,`values`,`showClearFilters`],[`column`,`id`],[`column`,`value`],[`column`,`desc`],[`column`,`type`,3,`options`],[`column`,`timestamp`],[`column`,`active`],[`size`,`xs`,`tuiChip`,``],[`column`,`type`,3,`options`,`appearanceMap`],[`size`,`xs`,`tuiChip`,``,3,`appearance`],[`column`,`type`],[`storageKey`,`ezui-table`,3,`values`,`showClearFilters`,`allowPresets`],[`column`,`types`,`optionLabel`,`value`,`optionValue`,`id`,3,`options`,`appearanceMap`],[`size`,`xs`,`tuiChip`,``,2,`margin-right`,`5px`,3,`appearance`]],template:function(t,y){t&1&&(v(0,`app-samplecontainer`,4),X(1,we,2,0,`ng-template`,null,0,Bt),_(),v(3,`app-samplecontainer`,5),X(4,ve,5,1,`ng-template`,null,0,Bt),_(),v(6,`app-samplecontainer`,6),X(7,Te,5,2,`ng-template`,null,0,Bt),_(),v(9,`app-samplecontainer`,7),X(10,ke,7,2,`ng-template`,null,0,Bt),_(),v(12,`app-samplecontainer`,8),X(13,De,5,2,`ng-template`,null,0,Bt),_(),v(15,`app-samplecontainer`,9),X(16,Me,7,2,`ng-template`,null,0,Bt),_(),v(18,`app-samplecontainer`,10),X(19,Ve,7,2,`ng-template`,null,0,Bt),_(),v(21,`app-samplecontainer`,11),X(22,He,7,2,`ng-template`,null,0,Bt),_(),v(24,`app-samplecontainer`,12),X(25,Ue,7,2,`ng-template`,null,0,Bt),_(),v(27,`app-samplecontainer`,13),X(28,qe,7,3,`ng-template`,null,0,Bt),_(),v(30,`app-samplecontainer`,14),X(31,Ye,7,2,`ng-template`,null,0,Bt),_(),v(33,`app-samplecontainer`,15),X(34,Ge,5,1,`ng-template`,null,0,Bt),_()),t&2&&(m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0),m(3),w(`enableTypescript`,!0))},dependencies:[Yt,Ct,hc,G,bO,FS,s5e,h,n5e,o5e,r5e,Gr,t5e,i5e,hH],encapsulation:2})};function Qe(e,r){if(e&1){let t=L();v(0,`ezui-orderlist`,5),Ve$1(`valuesChange`,function(c){M(t);let w=f();return ze$1(w.values,c)||(w.values=c),N(c)}),_(),A(1),Vt(2,`json`)}if(e&2){let t=f();Le$1(`values`,t.values),m(),K(` `,rr(2,2,t.values),` `)}}function Xe(e,r){e&1&&q(0,`ezui-orderlist`)}function Ze(e,r){if(e&1){let t=L();v(0,`ezui-orderlist`,6),Ve$1(`valuesChange`,function(c){M(t);let w=f();return ze$1(w.values,c)||(w.values=c),N(c)}),_()}if(e&2)Le$1(`values`,f().values),w(`disabled`,!0)}function et(e,r){if(e&1){let t=L();v(0,`ezui-orderlist`,7),Ve$1(`valuesChange`,function(c){M(t);let w=f();return ze$1(w.values,c)||(w.values=c),N(c)}),_(),A(1),Vt(2,`json`)}if(e&2){let t=f();Le$1(`values`,t.values),w(`showButtons`,!0),m(),K(` `,rr(2,3,t.values),` `)}}var P=class e{values=[{label:`item1`,icon:`list`},{label:`item2`,icon:`list`},{label:`item3`,icon:`list`},{label:`item4`,icon:`list`}];static ɵfac=function(t){return new(t||e)};static ɵcmp=k({type:e,selectors:[[`app-orderlist`]],hostAttrs:[1,`base-view`],decls:12,vars:0,consts:[[`preview`,``],[`label`,`Simple`,`html`,``],[`label`,`Empty`,`html`,``],[`label`,`Disabled`,`html`,``],[`label`,`Buttons`,`html`,``],[`optionLabel`,`label`,3,`valuesChange`,`values`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`disabled`],[`optionLabel`,`label`,3,`valuesChange`,`values`,`showButtons`]],template:function(t,y){t&1&&(v(0,`app-samplecontainer`,1),X(1,Qe,3,4,`ng-template`,null,0,Bt),_(),v(3,`app-samplecontainer`,2),X(4,Xe,1,0,`ng-template`,null,0,Bt),_(),v(6,`app-samplecontainer`,3),X(7,Ze,1,2,`ng-template`,null,0,Bt),_(),v(9,`app-samplecontainer`,4),X(10,et,3,5,`ng-template`,null,0,Bt),_())},dependencies:[Yt,Ct,G,KVe,mH],encapsulation:2})};var Ut=[{path:`markdowneditor`,component:F},{path:`tables`,component:O},{path:`iconselector`,component:C},{path:`showmoretext`,component:V},{path:`orderlist`,component:P}];export{Ut as default};