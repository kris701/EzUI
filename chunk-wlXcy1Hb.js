...
]`,3,`enableTypescript`],[3,`items`]],template:function(t,u){t&1&&(v(0,`app-samplecontainer`,1),K(1,A,1,1,`ng-template`,null,0,$t),y(),v(3,`app-samplecontainer`,2),K(4,R,1,1,`ng-template`,null,0,$t),y()),t&2&&(T(`enableTypescript`,!0),m(3),T(`enableTypescript`,!0))},dependencies:[Xt,zt,qQ,G],encapsulation:2})}},{path:`dialog`,component:w}];export{tt as default};