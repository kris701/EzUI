import{$ as m,A as UAe,C as Pu,D as S,F as We,H as ee,I as Y5,K as ht,N as Vi,O as Sl,P as WAe,Q as lm,S as PAe,T as R$1,W as ft,X as k,Y as jAe,_t as xn,a as E,at as qn,bt as zg,c as H,d as I,dt as un,et as mt,f as J,ft as v,gt as xC,ht as x,i as Bt,it as q,j as Uk,k as T,l as HAe,o as FAe,pt as vn,rt as pt,s as Ge,t as $Ae,tt as ne,vt as y,w as Qt,x as P,y as O,z as _}from"./main-KTYPZDBN.js";import{t as Y}from"./chunk-W9eYV-kN.js";var ae=(()=>{class e{static{this.ɵfac=function(u){return new(u||e)}}static{this.ɵcmp=I({type:e,selectors:[[`ng-component`]],exportAs:[`tui-message-5.18.0`],decls:0,vars:0,template:function(u,y){},styles:[`[tuiMessage]:where(*[data-tui-version="5.18.0"]){display:inline-flex;padding:.5rem .625rem;min-block-size:2.25rem;block-size:auto;box-sizing:border-box;inline-size:fit-content;isolation:isolate;white-space:nowrap;text-align:start;font:var(--%NS%tui-typography-ui-m);border-radius:var(--%NS%tui-radius-l)}[tuiMessage]:where(*[data-tui-version="5.18.0"])>[tuiLink]{color:inherit!important;text-decoration:underline solid!important}
